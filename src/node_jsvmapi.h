...
NODE_EXTERN napi_status napi_get_buffer_data(napi_env e, napi_value v, char** result);
NODE_EXTERN napi_status napi_get_buffer_length(napi_env e, napi_value v, size_t* result);
